 ...
 *
 * Restored verbatim from tag v1.0.0 (routine-engine folder). Intentionally
 * metadata-free (no timestamps, no elapsed counters). "No timers" is a
 * locked V1 decision; every timestamp we omit here is one fewer thing to
 * reconcile with persistent state later.
 *
