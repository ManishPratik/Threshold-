...
export const frozenRouter = createHashRouter([
  {
    ...
    children: [
      ...
      { path: '/modules', element: <ModulesRouteAdapter /> },
      { path: '/modules/routine', element: <RoutineRouteAdapter /> },
      { path: '/modules/smoking', element: <ModulesSmokingRouteAdapter /> },
